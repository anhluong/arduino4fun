/*********************************************************
* Title: Rainbowduino Smooth Plasma
* Based on: Pladma for the Meggy Jr. by Ken Corey
* Description: Smooth colour cyclilng for RGB LED matrices
* Version: 0.2 - 23/12/2010
* Changes: LED and colour adressing has been corrected.
*          Code formating cleaned up.
* 
* Copyright: 
* Copyright (c) 2010 CArlos Asmat - RobotsShop Inc.  All right reserved.
